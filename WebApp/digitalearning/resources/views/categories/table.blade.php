<div class="card-columns">
        ...
        <div class="card">  
  <img src="https://upload.wikimedia.org/wikipedia/ca/thumb/d/db/B%C3%BCy%C3%BCk_Birlik_Partisi.svg/239px-B%C3%BCy%C3%BCk_Birlik_Partisi.svg.png" class="card-img-top" alt="...">
  <div class="card-body">
...
?>
    ...
    <small class="text-muted">Views: {{ number_format($category->views_count)  }}</small>
  </ul>
  </div>
